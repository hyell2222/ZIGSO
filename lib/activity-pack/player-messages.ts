export const PLAYER_MESSAGES = {
  ...
  unknownItem: "아이템을 찾을 수 없습니다.",
  unknownTask: "미션을 찾을 수 없습니다.",
  incorrectAnswer: "정답이 아닙니다. 단서를 다시 확인해 보세요.",
  missingItems: "아직 모둠이 획득하지 않은 아이템이 있습니다.",
  taskIncompleteSubmission: "필수 제출 아이템을 모두 포함해야 미션을 완료할 수 있습니다.",
  taskInvalidItem: "이 미션에 사용할 수 없는 아이템입니다.",
