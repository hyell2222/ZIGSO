...
export const PHASE_STEP_GUIDES: Record<Exclude<TimedPhaseKey, "overview">, string[]> = {
  expert_group: [
    "내가 맡은 부분을 깊이 이해하고, 우리 모둠의 ‘전문가’가 되는 단계입니다.",
    "주어진 문제를 풀며 핵심 개념을 익혀 보세요. (AI 힌트·해설 제공, 오답 시 감점)",
    "같은 역할의 전문가들과 함께 내용을 정리하고, 홈 모둠원들에게 효과적으로 설명할 방법을 준비해 보세요."
  ],
  home_group: [
    "원래의 홈 모둠으로 돌아와, 각자 공부한 내용을 서로 가르치고 배우는 단계입니다.",
    "모둠원들의 설명을 들은 뒤 해당 내용의 문제를 풀어 보세요. (AI 힌트·해설 제공, 오답 시 감점)",
    "정답만 알려주기보다 질문과 토의를 통해 서로의 이해를 완성해 보세요."
  ],
  individual_quiz: [
    "혼자 힘으로 문제를 풀며 학습 내용을 점검하는 평가 단계입니다.",
    "지금까지 배운 내용을 바탕으로 자신의 이해도를 확인해 보세요.",
    "퀴즈 결과를 바탕으로 최종 향상 점수가 산출되며, 모둠 평균 점수로 최종 순위가 결정됩니다."
  ]
};
