...
function ActivityEditContent() {
  ...
  if (dataQuery.isError) {
    return (
      <div className="flex h-dvh flex-col items-center justify-center bg-[var(--background)] px-4">
        <p className="max-w-md rounded-md border border-[var(--danger)]/40 bg-[var(--danger)]/10 px-4 py-3 text-sm text-[var(--danger)]">
  ...
  if (!activityPack) {
    return (
      <div className="flex h-dvh flex-col items-center justify-center bg-[var(--background)] px-4">
        <p className="max-w-md rounded-md border border-[var(--panel-warn-border)] bg-[var(--panel-warn-bg)] px-4 py-3 text-sm text-[var(--foreground)]">
